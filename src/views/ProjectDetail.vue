...
const projects = [
  {
    ...
    title: 'SPA 租屋平台 (個人專案)',
    description:
      '前後端分離的 SPA 租屋平台，前端採用 Vue3，後端採用 Laravel API。',
  ...
  {
    id: 2,
    title: 'ESG 系統升級與重構 (公司專案)',
    description:
      '主導公司核心 ESG 系統從 CodeIgniter 3 到 CodeIgniter 4 的遷移與現代化重構。',
    link: '#',
    longDescription:
      '<div class="space-y-4">' +
  ...
  },
  {
    ...
    title: '物聯網應用專案 (大學專題)',
    description:
      '使用 Python 與樹莓派開發的物聯網控制應用，並將後端服務部署於 AWS EC2。',
    link: '#',
    longDescription:
      '<div class="space-y-4">' +
